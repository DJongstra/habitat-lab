...
parser.add_argument('--train-episodes', default=30, type=int, help='Number of training episodes per scene.') # default = 5000
...
# Output folder.
parser.add_argument('--output', default='./scenarios/datasets/hall3', help='Dataset root folder.')
